...
description: Analyzes Playwright test failures, identifies root cause, and creates detailed Jira bug tickets with titles prefixed "Dasha - ". Use when a test fails and needs investigation and bug reporting.
---
...
3. **Draft bug report** with:
   - **Title:** must start with `Dasha - ` followed by a clear, specific description (e.g., "Dasha - Program list shows stale data after editing program name")
   - **Type:** Bug
...
```
**Title:** Dasha - [Concise description of the defect.]
...
- Every bug title MUST begin with `Dasha - ` (include the space and hyphen)
